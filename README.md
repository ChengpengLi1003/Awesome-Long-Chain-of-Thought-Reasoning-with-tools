...
### WebSailor: Navigating Super-human Reasoning for Web Agent
  ...
  * 📄 **Paper:** [https://arxiv.org/pdf/2507.02592](https://arxiv.org/pdf/2507.02592)
  * 💻 **Code:** [https://github.com/Alibaba-NLP/WebAgent](https://github.com/Alibaba-NLP/WebAgent)
  * **Abstract:** This work posits that superhuman agentic reasoning hinges on the ability to systematically reduce extreme uncertainty when navigating vast information landscapes. The paper introduces WebSailor, a complete post-training methodology to instill this capability. The approach involves generating high-uncertainty tasks, using RFT for cold-starts, and a new agentic RL algorithm, Duplicating Sampling Policy Optimization (DUPO). WebSailor significantly outperforms all open-source agents in complex information-seeking tasks, matching the performance of proprietary agents.

### WebDancer: Towards Autonomous Information Seeking Agency

  * 📄 **Paper:** [https://arxiv.org/pdf/2505.22648](https://arxiv.org/pdf/2505.22648)
  * 💻 **Code:** [https://github.com/Alibaba-NLP/WebAgent](https://github.com/Alibaba-NLP/WebAgent)
  * **Abstract:** This work presents a cohesive paradigm for building end-to-end agentic information-seeking agents. The four-stage approach includes: (1) Browse data construction, (2) trajectory sampling, (3) supervised fine-tuning for a cold start, and (4) reinforcement learning for enhanced generalization. This framework is instantiated in a web agent called WebDancer. Evaluations on challenging benchmarks like GAIA and WebWalkerQA demonstrate strong performance, highlighting the efficacy of the training paradigm.
